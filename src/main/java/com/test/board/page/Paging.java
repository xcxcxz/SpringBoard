...
public class Paging {
	    ...
	    public Paging(int countPerPage, int pagePerGroup, int currentPage, int totalRecordsCount) {
		...
		public String toString() {
			return "Paging [countPerPage=" + countPerPage + ", pagePerGroup=" + pagePerGroup + ", currentPage="
