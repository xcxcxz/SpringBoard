...
<body>
	<div class="container text-center">
		...
		<div>▼개발자 github▼</div>
		<span class="glyphicon glyphicon-chevron-left" aria-hidden="true" onclick="plusDivs(-1)"></span>
		<img src="resources/img/GITHUB_QR.png" id=mainImage alt="slide" />  
		<span class="glyphicon glyphicon-chevron-right" aria-hidden="true" onclick="plusDivs(+1)"></span>
	</div>
